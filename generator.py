...
# ========== DNS НАСТРОЙКИ (СИСТЕМНЫЙ DNS НА ПЕРВОМ МЕСТЕ) ==========
# Добавлен system первым, чтобы дома подтягивался локальный роутер
DNS_PUBLIC = "system, https://1.1.1.1/dns-query, https://dns.google/dns-query"
# ===================================================================
...
def main():
    print(f"🔄 Запуск генератора с оптимизацией домашнего Wi-Fi для {GITHUB_USERNAME}...")
    ...
    dns_line = f"dns-server = {DNS_PUBLIC}"
...
"""
    ...
    print(f"🚀 Сборка завершена! Конфиг {CONFIG_FILE} пропатчен.")
